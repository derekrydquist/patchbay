  ...
  return (
    <div className="absolute bottom-0 left-[256px] right-0 z-40 h-3 bg-[#09090b]/80 border-t border-white/10 backdrop-blur-sm flex items-center pointer-events-none">
      ...
      >
        ...
        >
          <div 
            className="w-4 h-full hover:bg-white/20 cursor-ew-resize flex items-center justify-center transition-colors rounded-l-full"
            onPointerDown={(e) => handlePointerDown(e, 'left')}
          >
            <div className="w-[1px] h-1.5 bg-white/60 rounded-full" />
          </div>
          <div 
            className="w-4 h-full hover:bg-white/20 cursor-ew-resize flex items-center justify-center transition-colors rounded-r-full"
